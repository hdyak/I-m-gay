class Animals:
    def _init_(self, name, age, weight, habitat, diet):
        self.name = name
        self.age = age  
        self.weight = weight
...
class Reptiles(Animals):
    def _init_(self, name, age, weight, habitat, diet, scale_type):
        super()._init_(name, age, weight, habitat, diet)
...
class Mammals(Animals):
    def _init_(self, name, age, weight, habitat, diet, special_feature):
        super()._init_(name, age, weight, habitat, diet)
...
class ZooShow:
    def _init_(self, show_name, ticket_price, animal_performer):
